...
public class LoginActivity_GCMTest extends AppCompatActivity {

    private String TAG = LoginActivity_GCMTest.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_activity__gcmtest);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_Login_GCMTest);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getBoolean("error") == false) {
                        ...
                        // start main activity
                        startActivity(new Intent(getApplicationContext(), MainGCMTest.class));
                        finish();
