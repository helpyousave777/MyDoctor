...
public class GcmIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        // endpoint address is our local server + UserID
        String endPoint = EndPoints.USER.replace("_ID_", user.getId());

        Log.i(TAG, "endpoint: " + endPoint);

        // it use volley library for sending data to server ( PUT) via endpoint address
    ...
    public static void subscribeToTopic(String topic) {
        ...
        try {
            ...
            Log.i(TAG, "Topic subscribe error. Topic: " + topic + ", error: " + e.getMessage());
