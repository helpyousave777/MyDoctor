package com.example.saeed_pc.mydoctor.Main_MyDr.GCM.gcm;
...
import com.example.saeed_pc.mydoctor.Main_MyDr.GCM.ChatRoomActivity;
...
import com.example.saeed_pc.mydoctor.Main_MyDr.GCM.model.User;
...
public class MyGcmPushReceiver extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle bundle) {
        ...
        if(MyApplication.getInstance().getPrefManager().getUser() == null){
            ...
            Log.i(TAG, "user is not logged in, skipping push notification");
            return;
        }
        ...
        if (!isBackground) {
            ...
            try {
                ...
                if (uObj.getString("user_id").equals(MyApplication.getInstance().getPrefManager().getUser().getId())) {
                    Log.i(TAG, "Skipping the push message as it belongs to same user");
                    return;
                }
        ...
        if (!isBackground) {
            ...
            try {
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    // app is in background. show the message in notification try
                    Intent resultIntent = new Intent(getApplicationContext(), MainGCMTest.class);
